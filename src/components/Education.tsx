              ...
              >
                ...
                <div className="relative flex flex-col items-center">
                  ...
                  <div className="mb-8 w-full flex justify-center">
                    <div className="rounded-lg overflow-hidden border border-emerald-500/30 bg-slate-900/50 shadow-2xl animate-float-vertical" style={{ perspective: '1000px', width: '300px' }}>
                      <img
                  ...
                  <div className="text-center w-full">
                    <div className="w-12 h-12 rounded-xl bg-emerald-500/20 border border-emerald-500/40 flex items-center justify-center mb-4 group-hover:bg-emerald-500/30 transition-all duration-300 mx-auto">
                    ...
                    <div className="mb-4">
                      ...
                      <p className="text-slate-500 text-xs break-all font-mono max-w-sm mx-auto">
